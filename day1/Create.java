...
public class Create {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("Aravind");
		
		driver.findElement(By.id("createLeadForm_primaryPhoneNumber")).sendKeys("9600579204");
		
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("ramesharavindhkarthikeyan@gmail.com");
